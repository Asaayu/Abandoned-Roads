  params [["_per1", 13], ["_per2", 5], ["_per3", 2], ["_debug",false]];
  ...
  systemChat str format["Asaayu's Abandoned Roads ----------- %1 simple objects have been created around %3 in %2 seconds! -----------",_counter,(diag_tickTime - _time), toUpper worldName];
